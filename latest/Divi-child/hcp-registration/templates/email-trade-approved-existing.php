<?php
/**
 * Trade Application approval email template for EXISTING users (HTML).
 *
 * Variables available: $request, $login_url, $site_name, $user.
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background-color:#ffffff;margin:0 auto;width:100%;font-family:Arial,sans-serif;">
                    <tr>
                        <td style="padding:40px 32px;color:#0b1d3a;font-family:Arial,sans-serif;">
                            ...
                            <p style="margin:0 0 24px 0;font-family:Arial,sans-serif;font-size:16px;color:#0b1d3a;">
                                <?php esc_html_e( 'You can log in using your existing credentials.', 'hcp-registration' ); ?>
                            </p>

                            <p style="margin:0 0 40px 0;text-align:center;">
                                <a href="<?php echo esc_url( $login_url ); ?>" style="background-color:#0b1d3a;color:#ffffff;display:inline-block;font-family:Arial,sans-serif;font-size:16px;font-weight:700;line-height:1.2;padding:14px 28px;text-decoration:none;border-radius:0;">
                                    <?php esc_html_e( 'Log In', 'hcp-registration' ); ?>
                                </a>
                            </p>
