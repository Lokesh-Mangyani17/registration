...
<?php if ( $has_orders ) : ?>
	<div class="nubu_woocommerce_my_account_endpoint_header">
		<div class="nubu_woocommerce_my_account_endpoint_heading_wrapper">
			<h4 class="nubu_woocommerce_my_account_endpoint_heading"><?php esc_html_e( 'All Orders', 'divi' ); ?></h4>
			<span class="nubu_woocommerce_my_account_endpoint_counter"><?php echo wp_kses_post( sprintf( _n( '%1$s Order', '%1$s Orders', $customer_orders->total, 'woocommerce' ), $customer_orders->total ) ) ?></span>
		</div>
	</div>
					...
					?>
						<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
							<?php
							    ...
							    ?>
							        <span class="nubu_woocommerce_orders_table_cell_header"><?php echo esc_html( $column_name ); ?></span>
							    ...
							    <?php } elseif ( 'order-status' === $column_id ) {
							        ?><span class="nubu_woocommerce_orders_table_cell_header"><?php echo esc_html( $column_name ); ?></span><?php
